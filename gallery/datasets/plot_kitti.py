...
This example demonstrates using the KITTI 3D Object Detection dataset
with :class:`vision3d.datasets.Kitti3D`. It covers
inspecting the :class:`~vision3d.datasets.FusionInputs`,
...
# ---------------------
# :class:`~vision3d.datasets.Kitti3D` yields sample frames describing
# the 3D scene. Each sample carries lidar points, the left color camera
# image, its intrinsics and extrinsics, and 3D bounding-box annotations
...
# :class:`~vision3d.datasets.FusionInputs` /
