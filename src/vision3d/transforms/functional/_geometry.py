...
def flip_3d[S: IntTuple](inpt: "Tensor[S]", *, axis: str) -> "Tensor[S]":
...
def flip_3d_point_cloud[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, axis: str
    ...
    idx = AXIS_INDEX[axis]
    shape = points.shape
    points = points.clone().reshape(-1, shape[-1])  # pyrefly: ignore[bad-assignment]
    points[:, idx].neg_()
    return points.reshape(shape)


@register_kernel(flip_3d, PointCloud3D)
def _flip_3d_point_cloud_kernel[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, axis: str
) -> "Tensor[[*Elements[Bs], D]]":
    return flip_3d_point_cloud(points, axis=axis)


def flip_3d_bounding_boxes[Bs: IntTuple, K: IntVar](
    boxes: "Tensor[[*Elements[Bs], K]]", *, format: BoundingBox3DFormat, axis: str
) -> "Tensor[[*Elements[Bs], K]]":
    ...
    idx = AXIS_INDEX[axis]
    shape = boxes.shape
    boxes = boxes.clone().reshape(-1, shape[-1])  # pyrefly: ignore[bad-assignment]
...
def translate_3d[S: IntTuple](
    inpt: "Tensor[S]", *, offset: "Tensor[[3]]"
) -> "Tensor[S]":
...
def translate_3d_point_cloud[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, offset: "Tensor[[3]]"
) -> "Tensor[[*Elements[Bs], D]]":
...
def _translate_3d_point_cloud_kernel[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, offset: "Tensor[[3]]"
) -> "Tensor[[*Elements[Bs], D]]":
    return translate_3d_point_cloud(points, offset=offset)


def translate_3d_bounding_boxes[Bs: IntTuple, K: IntVar](
    boxes: "Tensor[[*Elements[Bs], K]]",
    *,
...
def translate_3d_camera_extrinsics[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, offset: "Tensor[[3]]"
...
def _translate_3d_camera_extrinsics_kernel[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, offset: "Tensor[[3]]"
) -> "Tensor[[*Elements[Bs], 4, 4]]":
...
def rotate_3d[S: IntTuple](
    inpt: "Tensor[S]", *, rotation_matrix: "Tensor[[3, 3]]"
) -> "Tensor[S]":
...
def rotate_3d_point_cloud[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, rotation_matrix: "Tensor[[3, 3]]"
) -> "Tensor[[*Elements[Bs], D]]":
...
def _rotate_3d_point_cloud_kernel[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, rotation_matrix: "Tensor[[3, 3]]"
) -> "Tensor[[*Elements[Bs], D]]":
    return rotate_3d_point_cloud(points, rotation_matrix=rotation_matrix)


def rotate_3d_bounding_boxes[Bs: IntTuple, K: IntVar](
    boxes: "Tensor[[*Elements[Bs], K]]",
    *,
    format: BoundingBox3DFormat,
...
def rotate_3d_camera_extrinsics[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, rotation_matrix: "Tensor[[3, 3]]"
) -> "Tensor[[*Elements[Bs], 4, 4]]":
...
def _rotate_3d_camera_extrinsics_kernel[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, rotation_matrix: "Tensor[[3, 3]]"
) -> "Tensor[[*Elements[Bs], 4, 4]]":
    return rotate_3d_camera_extrinsics(extrinsics, rotation_matrix=rotation_matrix)


def scale_3d[S: IntTuple](inpt: "Tensor[S]", *, factor: float) -> "Tensor[S]":
...
def scale_3d_point_cloud[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, factor: float
) -> "Tensor[[*Elements[Bs], D]]":
...
def scale_3d_bounding_boxes[Bs: IntTuple, K: IntVar](
    boxes: "Tensor[[*Elements[Bs], K]]", *, format: BoundingBox3DFormat, factor: float
) -> "Tensor[[*Elements[Bs], K]]":
...
def _scale_3d_point_cloud_kernel[Bs: IntTuple, D: IntVar](
    points: "Tensor[[*Elements[Bs], D]]", *, factor: float
) -> "Tensor[[*Elements[Bs], D]]":
...
def scale_3d_camera_extrinsics[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, factor: float
) -> "Tensor[[*Elements[Bs], 4, 4]]":
...
def _scale_3d_camera_extrinsics_kernel[Bs: IntTuple](
    extrinsics: "Tensor[[*Elements[Bs], 4, 4]]", *, factor: float
) -> "Tensor[[*Elements[Bs], 4, 4]]":
