...
def points_in_boxes_3d[N: IntVar, M: IntVar](
    points: "Tensor[[N, int]]",
    boxes: "Tensor[[M, int]]",
...
def points_in_boxes_3d_indices[N: IntVar, M: IntVar](
    points: "Tensor[[N, int]]",
    boxes: "Tensor[[M, int]]",
    format: BoundingBox3DFormat,
) -> "Tensor[[N]]":
...
def extract_box3d_params[M: IntVar](
    boxes: "Tensor[[M, int]]", format: BoundingBox3DFormat
