...
impl SpatialView3D {
    pub fn view_3d(
        ...
        crate::box_drag::handle(ctx, ui, &response, &eye, ui_rect, state);
        ...
        // Brush overlay goes after the renderer callback, or the point cloud
        // would be composited over the dimming veil and the highlights.
        crate::brush::handle(ctx, ui, &response, &eye, ui_rect, query);
