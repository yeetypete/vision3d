...
import builtins
from typing import Any, NamedTuple, overload, Self, TYPE_CHECKING
...
# Operator registry (torch.ops namespace for custom C++/CUDA extensions)
ops: Any
...
class CumResult[*Shape](NamedTuple):
    values: Tensor[*Shape]
    indices: Tensor[*Shape]

class SortResult[*Shape](NamedTuple):
    values: Tensor[*Shape]
    indices: Tensor[*Shape]
...
class Tensor[*Shape]:
    ...
    def __getitem__(
        ...
        | builtins.ellipsis
        | tuple[
            int | builtins.bool | slice | builtins.ellipsis | Tensor | list[int] | None,
            ...,
        ]
        | Tensor
        | list[int],
    ...
    def __and__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __rand__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __iand__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __or__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __ror__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __ior__(self, other: Tensor | builtins.bool | int) -> Self: ...
    def __xor__(self, other: Tensor | builtins.bool | int) -> Self: ...
    ...
    def new_empty(
        ...
        """Create uninitialized tensor with same dtype/device (tuple form)."""
        ...
    ...
    def cummax[*Shape](self: Tensor[*Shape], dim: int) -> CumResult[*Shape]:
        """Cumulative maximum along dimension. Returns named tuple (values, indices)."""
        ...

    def cummin[*Shape](self: Tensor[*Shape], dim: int) -> CumResult[*Shape]:
        """Cumulative minimum along dimension. Returns named tuple (values, indices)."""
        ...
    ...
    def sort[*Shape](
        ...
        """Sort tensor. Returns named tuple (values, indices). Shape-preserving."""
        ...
    ...
    # ==== Additional Methods ====
    def as_subclass(self, cls: type) -> Self: ...
    def numpy(self) -> Any: ...
    def flip(
        self, dims: builtins.int | tuple[builtins.int, ...] | list[builtins.int]
    ) -> Self: ...
    def neg_(self) -> Self: ...
    def abs_(self) -> Self: ...
    def clamp_(
    ...
    def zero_(self) -> Self: ...
    def fill_(self, value: builtins.float | builtins.int) -> Self: ...
    def copy_(self, src: Tensor, non_blocking: builtins.bool = False) -> Self: ...
    def add_(
        self,
        other: Tensor | builtins.float | builtins.int,
        alpha: builtins.float | builtins.int = 1,
    ) -> Self: ...
    def sub_(
        self,
        other: Tensor | builtins.float | builtins.int,
    ...
    def mul_(self, other: Tensor | builtins.float | builtins.int) -> Self: ...
    def div_(self, other: Tensor | builtins.float | builtins.int) -> Self: ...
    def is_floating_point(self) -> builtins.bool: ...
    def fill_diagonal_(
        self, fill_value: builtins.float | builtins.int, wrap: builtins.bool = False
    ) -> Self: ...
...
def full(
    size: tuple[int, ...], fill_value: float, *, dtype: Any = None, device: Any = None
) -> Tensor:
...
def eye(
    n: int, m: int | None = None, *, dtype: Any = None, device: Any = None
) -> Tensor:
...
def cummax[*Shape](input: Tensor[*Shape], dim: int) -> CumResult[*Shape]:
    """Cumulative maximum along dimension. Returns named tuple (values, indices)."""
    ...

def cummin[*Shape](input: Tensor[*Shape], dim: int) -> CumResult[*Shape]:
    """Cumulative minimum along dimension. Returns named tuple (values, indices)."""
    ...
...
def zeros_like[*Shape](
    input: Tensor[*Shape], *, dtype: Any = None, device: Any = None
) -> Tensor[*Shape]:
...
def where(condition: Tensor) -> tuple[Tensor, ...]:
    """Return indices of nonzero elements (single-arg form)."""
    ...
...
def is_floating_point(input: Tensor) -> builtins.bool: ...
def randperm(n: int, *, dtype: Any = None, device: Any = None) -> Tensor: ...
def searchsorted(
    sorted_sequence: Tensor,
    values: Tensor,
    *,
    out_int32: builtins.bool = False,
    right: builtins.bool = False,
) -> Tensor: ...
def quantile(
    input: Tensor,
    q: float | Tensor,
...
def _check(condition: builtins.bool, message: str | Any = "") -> None: ...
...
def manual_seed(seed: builtins.int) -> Any: ...
def compile(
    model: Any = None,
    *,
...
class library:
    """Namespace for torch.library functions."""
    @staticmethod
    def custom_op(
        name: str,
        fn: Any = None,
    ...
    @staticmethod
    def register_fake(name: str, fn: Any = None) -> Any: ...
